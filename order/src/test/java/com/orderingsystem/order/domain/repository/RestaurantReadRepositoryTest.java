...
@ActiveProfiles("test")
@DataJpaTest
class RestaurantReadRepositoryTest {

    @Autowired
    private RestaurantReadRepository restaurantReadRepository;
    ...
    @BeforeEach
    void setUp() {
        restaurantReadRepository.save(Restaurant.builder()
    ...
    void findRestaurantInfo() {
        //when
        List<RestaurantInfoView> restaurantInfo = restaurantReadRepository.findRestaurantInfo(restaurantId,
