...
public class RestaurantValidateOrderService {
    ...
    public OrderAcceptEvent validateOrder(RestaurantInfo restaurant, List<String> failureMessages, UUID sagaId) {
        ...
        if (failureMessages.isEmpty()) {
            ...
            return restaurant.declineOrder(failureMessages, sagaId);
        }
    }
}
